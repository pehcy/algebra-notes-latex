...
\begin{mdframed}
    ...
    \vspace{0.752cm}
    \begin{Exercise}
        Find the conjugacy classes of dihedral group order 4. 
    \end{Exercise}
    \begin{Answer}
        The dihedral group of order 4 is 
        \[
            D_4 = \{ e, r, r^2, r^3, s, sr, sr^2, sr^3 \}
        \]
        The members of a conjugacy class of $D_4$ are different but have the 
